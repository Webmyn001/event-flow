...
function Homepage() {
  ...
  return (
    <div className='text-white bg-fuchsia-950 w-full min-h-screen'>
       ...
       <h4 className='text-xl font-medium text-center pt-[50px]'>Kindly click on the bottons below to Sign up or to Log in to the System</h4>

       <div className='flex justify-center items-center pt-[100px] gap-x-5'>

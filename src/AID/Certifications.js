    ...
    <div>
        ...
        <div>
            <div className='flex flex-col sm:flex sm:flex-row gap-5 sm:gap-y-8 pt-2 py-5 justify-center items-center' data-aos="flip-down">
                <img src={Image1} alt='Certificate' className='h-[300px] w-[300px] rounded-lg object-cover hover:scale-105  transition duration-500' />
                <img src={Image2} alt='Certificate' className='h-[300px] w-[300px] rounded-lg object-cover hover:scale-105  transition duration-500' />
            </div>
        </div> 
    </div>
  )
